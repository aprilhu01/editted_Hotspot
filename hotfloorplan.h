...
typedef struct global_config_t_st
{
	...
	/* my changes : define number of layer*/
	char num_layer[MAX_LAYER];
}global_config_t;
...
/*my changes : transfer string pairs to integer pairs*/
//int* global_strs_to_int(global_config_t *config, str_pair *table, int max_entries);
